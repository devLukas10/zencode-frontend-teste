...
export const CadidateExperienceInfoForm = ({show, data, next, onPreview, cb}: CandidateFormTypes)=> {
    ...
    >
        ...
        >
            <InputGroup.Input
                value={_currentData?.experience_years}
                onChange={(txt)=> setCurrentData({..._currentData, experience_years: txt})}
                type="text"
        ...
        >
            <InputGroup.Input
                value={_currentData?.current_company}
                onChange={(txt)=> setCurrentData({..._currentData, current_company: txt})}
                placeholder="- - - - - -"
                className="w-full"
                required={true}
            />
        ...
        >
            <InputGroup.Input
                value={_currentData?.technlogies}
                onChange={(txt)=> setCurrentData({..._currentData, technlogies: txt})}
                placeholder="- - - - - -"
                className="w-full"
                required={true}
            />
